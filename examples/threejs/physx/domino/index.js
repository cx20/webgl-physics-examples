...
function init(PhysX) {
    ...
    let ground = new Ground(0, -2 * SCALE, 0, 300 * SCALE, 1, 300 * SCALE, texture_grass, 0xdddddd);
    ...
    function createDominos() {
        ...
        for ( let y = 0; y < 16; y++ ) {
            for ( let x = 0; x < 16; x++ ) {
                ...
                let box = new Box(x1, y1, z1, 0.2 * BOX_SIZE * SCALE, 1.2 * BOX_SIZE * SCALE, 1 * BOX_SIZE * SCALE, null, color);
    ...
    function createShapes() {
        ...
        for ( let y = 0; y < 16; y++ ) {
            ...
            let y1 = 10 * BOX_SIZE * SCALE;
            let z1 = (-8 + (15 - y)) * BOX_SIZE * SCALE * 1.2;
            let color = getRgbColor("白");
            let ball = new Ball(x1, y1, z1, BALL_SIZE * SCALE, texture_football, color);
