// Filament + Havok — glTF Physics "Filtering" (collision filtering) sample.
//
// Renders the Khronos glTF_Physics "Filtering" model with Google Filament and simulates it with
// Havok via the KHR_physics_rigid_bodies / KHR_implicit_shapes extensions. This scene shows
// collision filtering: bodies are tagged with collision systems (collisionFilters) so that, e.g.,
