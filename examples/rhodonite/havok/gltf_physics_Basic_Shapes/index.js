...
const load = async function () {
  ...
  if (typeof HK.HP_Shape_CreateContainer === 'function') {
    for (const nodeIndex of sceneNodeIndices) {
      ...
      const bodyId = createBody(containerId, HK.MotionType.DYNAMIC, parentDec.t, parentDec.r, true);
  ...
  for (const nodeIndex of sceneNodeIndices) {
    ...
    const bodyId = createBody(shapeResult.shapeId, motionType, bodyPosition, rotation, isDynamic);
