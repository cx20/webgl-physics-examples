...
const createScene = function() {
    ...
    for (let y = 0; y < 16; y++) {
        for (let x = 0; x < 16; x++) {
            ...
            const sAggregate = new BABYLON.PhysicsAggregate(s, BABYLON.PhysicsShapeType.SPHERE, { mass: 1, friction: 0.4, restitution: 0.6}, scene);
    ...
    scene.registerBeforeRender(function() {
        objects.forEach(function(obj) {
            if (obj.position.y < -100 * PHYSICS_SCALE) {
                ...
                //obj.physicsBody.setLinearVelocity(new BABYLON.Vector3(0,0,0));
                new BABYLON.PhysicsAggregate(obj, BABYLON.PhysicsShapeType.SPHERE, { mass: 1, friction: 0.4, restitution: 0.6}, scene);	// TODO: Need to make sure this method is OK
            }
        });
